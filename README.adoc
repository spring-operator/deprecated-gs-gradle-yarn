...
[source,text]
----
gs-gradle-yarn-dist/target/dist/gs-gradle-yarn-client-0.1.0.jar
gs-gradle-yarn-dist/target/dist/gs-gradle-yarn-container-0.1.0.jar
gs-gradle-yarn-dist/target/dist/gs-gradle-yarn-appmaster-0.1.0.jar
----

You can run the project with `cd gs-gradle-yarn-dist && java -jar
target/dist/gs-gradle-yarn-client-0.1.0.jar` but we haven't added the code to 
